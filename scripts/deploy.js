...
async function main() {
    ...
    const Jokes = await hre.ethers.getContractFactory("Jokes")
    const jokes = await Jokes.deploy();
    await jokes.waitForDeployment();

    console.log("Jokes Contract Address", await jokes.getAddress())
